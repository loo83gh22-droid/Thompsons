...
const tiers = [
  {
    ...
    features: [
      ...
      "All core features — Journal, Stories, Recipes, Traditions, Time Capsules, Voice Memos, Events & more",
      "1 GB photo storage",
  ...
  },
  {
    ...
    description: "Room for your whole family to grow.",
    badge: "Most Popular",
    features: [
      ...
      "Video uploads",
      "Family Map (full editing — add & manage locations)",
