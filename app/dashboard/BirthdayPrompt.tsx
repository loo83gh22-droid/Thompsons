          ...
          {birthdays.map((birthday) => (
            ...
            >
              ...
              <Link
                ...
                className="mt-3 inline-flex w-full items-center justify-center rounded-lg bg-[var(--accent)] px-4 py-2 text-sm font-medium text-[var(--background)] transition-all hover:brightness-110"
                onClick={() =>
                  handleDismiss("birthday", `${birthday.date}-${birthday.memberId}`)
                }
              >
